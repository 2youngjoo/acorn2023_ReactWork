...
class App extends Component{
  ...
  // mousemove 이벤트가 발생했을 때 실행할 함수 만들기
  onMouseMove = (e)=>{
    console.log(`
      x : ${e.clientX}
      y : ${e.clientY}
  ...
  render(){
    ...
    return (
      <div className="container">
        <h1>인덱스 페이지 입니다.</h1>
        {/* 
            여기는 jsx 내부에서의 주석 입니다.
            버튼을 눌렀을 때 실행할 함수를 onClick 속성의 값으로 직적 전달하기
        */}
        <button onClick={()=>{
          console.log("전송합니다!");
        }}>전송</button>
        {/* 미리 만들어 놓은 함수를 참조해서 전달할 수도 있다. */}
        ...
        {/* 
            ...
            original 이벤트 객체를 사용하고 싶다면 e.nativeEvent 사용하면 된다.
        */}
